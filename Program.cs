    ...
    internal static class SelfTests
    {
        public static int Run()
        {
            ...
            try
            {
                ...
                string referencePrompt = ImageApiClient.BuildGeminiPrompt("user prompt remains", true, false);
                ...
                string openAiWithoutReference = ImageApiClient.BuildOpenAiPrompt("unchanged prompt", false, false);
                string openAiWithReference = ImageApiClient.BuildOpenAiPrompt("unchanged prompt", true, false);
                ...
                using (MultipartFormDataContent openAiReferenceForm = ImageApiClient.BuildOpenAiForm(
                    new AppSettings(), "prompt", new byte[] { 1 }, new byte[] { 2 }, new byte[] { 3 }, false, 1024, 1024))
                {
                ...
                using (MultipartFormDataContent openAiPlainForm = ImageApiClient.BuildOpenAiForm(
                    new AppSettings(), "prompt", new byte[] { 1 }, new byte[] { 2 }, null, false, 512, 512))
                {
